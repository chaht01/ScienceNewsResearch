...
const IntroView = ({ user_detail, page, nextPage }) => {
  ...
  const instructions = [
    ...
    {
      text:
        "Answer to other's questions (5-10 min) Questions generated by other users will be shown. Answer 5 or more questions that can be answered by the article you read. Answer to 5 or more of others’ question after reading the article. ",
      children: [
      ]
    }
  ];
