...
const IntroView = ({ user_detail, page, nextPage }) => {
  ...
  const instructions = [
    {
      text: "Question before reading (5 min): Title of the article will be presented. After reading the title, raise 3 or more questions on what you expect to read from the article.",
      children: [
      ]
    },
    {
    ...
    {
      text:
        "Answer other's questions (5-10 min): Questions generated by other users will be shown. Answer 5 or more questions that can be answered by the article you read.",
      children: [
      ]
    }
  ];
