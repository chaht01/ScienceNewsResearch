      ...
      <StyledIntro>
        ...
        {this.state.pos === 0 && (
          <React.Fragment>
            ...
            You should raise 3 or more questions in total. However, please raise questions as many as you can.
            </p>
          </React.Fragment>
        )}
        {this.state.pos === 1 && (
        ...
        {this.state.pos === 2 && (
          <React.Fragment>
            ...
            <p style={{fontSize:16}}> From now on, we will explain how you can generate questions.</p>
              <p>
                <p style={{fontSize:16}}>2. Type in your question and click 'add' button.</p>
        ...
        {this.state.pos === 5 && (
          <React.Fragment>
            ...
            <p style={{fontSize:16}}> From now on, we will explain how you can generate questions.</p>
              <p>
                <p style={{fontSize:16}}> If you can not think of a new question anymore, click 'See others' questions' button. </p>
