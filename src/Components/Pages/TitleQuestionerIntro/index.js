      ...
      <StyledIntro>
        ...
        {this.state.pos === 5 && (
          <React.Fragment>
            ...
            <p style={{fontSize:16}}> From now on, we will explain how you can generate questions.</p>
              <p>
                <p style={{fontSize:16}}> If you cannat think of new question anymore, click 'I cannot think of new question' button. Discover questions generated by other readers. We hope seeing other readers' questions will inspire you to come up with new questions.</p>
